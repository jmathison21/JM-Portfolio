...
function Bio({bio}) {
    ...
    return(
    <div className="flex flex-row flex-grow flex-wrap w-full md:w-4/5 justify-center">
...
function Resume ({resume}) {
    ...
    <div className="flex flex-row p-2 rounded-xl bg-white">
        <Image width={60} height={60} src={resume["icon-pdf"]} alt={resume["icon-pdf-alt"]}/>
